...
export const DEFAULT_PREFERENCES = {
  planner: ["gemini-2.5-pro", "gemini-3.1-pro-preview", "claude-3-5-sonnet", "gpt-4o"],
  developer: ["gemini-2.5-flash", "claude-3-5-sonnet", "gpt-4o"],
  reviewer: ["gemini-2.5-flash", "claude-3-haiku", "gpt-4o-mini"],
};
