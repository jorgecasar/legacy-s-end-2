...
targets: ["*"]
description: >-
  Systems and mechanics architect. Designs gameplay loops, economies, player progression,
  and authors GDDs that engineers and artists can execute without ambiguity. Use when
  defining new mechanics, balancing systems, or documenting gameplay design decisions.
claudecode:
  model: inherit
---
