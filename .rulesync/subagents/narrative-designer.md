...
targets: ["*"]
description: >-
  Story systems and dialogue architect. Designs branching narrative, lore architecture,
  and environmental storytelling that integrate with gameplay (not cutscene-style filler).
  Use when writing dialogue, structuring story branches, or evolving the world lore for
  Alarion's Awakening.
claudecode:
  model: inherit
---
