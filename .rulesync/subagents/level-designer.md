...
targets: ["*"]
description: >-
  Spatial storytelling and flow specialist. Designs level layouts, pacing, encounter
  rhythm, and environmental narrative for authored player experiences. Use when designing
  new levels, iterating on existing ones, or evaluating spatial flow for the game.
claudecode:
  model: inherit
---
